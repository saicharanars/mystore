...
import { AlertCircle, CircleX, Plus, Upload } from 'lucide-react';
...
import { toast } from '@ecommerce/ui-kit/ui/lib/ui/use-toast';
...
const CreateProductForm = () => {
  ...
  if (imageError || productError) {
    return (
      <Alert variant="destructive" className="max-w-sm m-4 mx-auto">
        ...
        <AlertDescription>
          {`An error occurred: ${
            ((imageError || productError) as { message?: string }).message ||
  ...
  return (
    <div className="mt-4">
      <h1 className="max-w-2xl mx-auto  bg-background p-6 rounded-lg font-bold text-2xl">
        {' '}
